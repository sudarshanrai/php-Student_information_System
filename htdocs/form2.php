...
<form class="contact_form" action="ex.php" autocomplete="on" method="post" onsubmit="return confirm('Are you sure you want to submit?')">
...
<td><input type="text" name="year" size="3"></td>
</tr>
</table>
<br>
...
<tr>
<td>TENTH</td>
<td align="center">&nbsp;<input type="text" name="10board" size="3"></td>
<td align="center">&nbsp;<input type="text" name="10inst" size="3"></td>
<td align="center">&nbsp;<input type="text" name="10perc" size="3"></td>
<td align="center">&nbsp;<input type="text" name="10pass" size="3"></td>
<td align="center">&nbsp;<input type="text" name="10noa" size="3"></td>
</tr>
<tr>
<td align="center">12th</td>
<td align="center">&nbsp;<input type="text" name="12board" size="3"></td>
<td align="center">&nbsp;<input type="text" name="12inst" size="3"></td>
<td align="center">&nbsp;<input type="text" name="12perc" size="3"></td>
<td align="center">&nbsp;<input type="text" name="12pass" size="3"></td>
<td align="center">&nbsp;<input type="text" name="12noa" size="3"></td>
</tr>
<tr>
...
<tr>
<tr><td><br></td></tr>
<td>CGPA upto:<input list="semno" name="sem" size="1" required>
  <datalist  id="semno" >
    <option value="1st">
    <option value="2nd">
	<option value="3rd">
