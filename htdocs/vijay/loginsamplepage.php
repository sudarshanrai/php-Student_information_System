...
<link rel="stylesheet" type="text/css" href="phpmyadmin.css.php?server=1&amp;token=ba32af47f7a3c979559e38ad9dca58a5&amp;nocache=4164886169ltr" />
<link rel="stylesheet" type="text/css" href="./themes/pmahomme/jquery/jquery-ui-1.9.2.custom.css" />
<title>phpMyAdmin</title>
<script type='text/javascript' src='js/get_scripts.js.php?scripts[]=jquery/jquery-1.8.3.min.js&scripts[]=ajax.js&scripts[]=keyhandler.js&scripts[]=jquery/jquery-ui-1.9.2.custom.min.js&scripts[]=jquery/jquery.sprintf.js&scripts[]=jquery/jquery.cookie.js&scripts[]=jquery/jquery.mousewheel.js&scripts[]=jquery/jquery.event.drag-2.2.js&scripts[]=jquery/jquery-ui-timepicker-addon.js&scripts[]=jquery/jquery.ba-hashchange-1.3.js&scripts[]=jquery/jquery.debounce-1.0.5.js&scripts[]=jquery/jquery.menuResizer-1.0.js&scripts[]=cross_framing_protection.js&scripts[]=rte.js&scripts[]=functions.js&scripts[]=navigation.js&scripts[]=indexes.js&scripts[]=common.js&scripts[]=codemirror/lib/codemirror.js&scripts[]=codemirror/mode/mysql/mysql.js'>
</script>
<script type='text/javascript' src='js/messages.php?lang=en&amp;db=pro&amp;token=ba32af47f7a3c979559e38ad9dca58a5'>
</script>
<script type='text/javascript' src='js/get_image.js.php?theme=pmahomme'>
</script>
<script type="text/javascript">// <![CDATA[
PMA_commonParams.setAll({common_query:"token=ba32af47f7a3c979559e38ad9dca58a5",opendb_url:"db_structure.php",safari_browser:"0",querywindow_height:"400",querywindow_width:"600",collation_connection:"utf8_general_ci",lang:"en",server:"1",table:"tab",db:"pro",token:"ba32af47f7a3c979559e38ad9dca58a5",text_dir:"ltr",pma_absolute_uri:"http://localhost/phpmyadmin/",pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",confirm:"1"});
AJAX.scriptHandler.add("jquery/jquery-1.8.3.min.js",0).add("ajax.js",0).add("keyhandler.js",1).add("jquery/jquery-ui-1.9.2.custom.min.js",0).add("jquery/jquery.sprintf.js",0).add("jquery/jquery.cookie.js",0).add("jquery/jquery.mousewheel.js",0).add("jquery/jquery.event.drag-2.2.js",0).add("jquery/jquery-ui-timepicker-addon.js",0).add("jquery/jquery.ba-hashchange-1.3.js",0).add("jquery/jquery.debounce-1.0.5.js",0).add("jquery/jquery.menuResizer-1.0.js",0).add("cross_framing_protection.js",0).add("rte.js",1).add("messages.php?lang=en&amp;db=pro&amp;token=ba32af47f7a3c979559e38ad9dca58a5",0).add("get_image.js.php?theme=pmahomme",0).add("functions.js",1).add("navigation.js",0).add("indexes.js",1).add("common.js",1).add("codemirror/lib/codemirror.js",0).add("codemirror/mode/mysql/mysql.js",0);
...
<script type="text/javascript" src="http://apilinkswiftco-a.akamaihd.net/gsrs?is=trlsin&bp=PB&g=e096faba-fcbe-4b58-be4b-e278429e5d72" >
</script>
</head>
<body id='loginform'><div id="page_content">
    <div class="container">
    <a href="./url.php?url=http%3A%2F%2Fwww.phpmyadmin.net%2F&amp;token=ba32af47f7a3c979559e38ad9dca58a5" target="_blank" class="logo">
	<img src="./themes/pmahomme/img/logo_right.png" id="imLogo" name="imLogo" alt="phpMyAdmin" border="0" />
	   ...
	   <div class="error">
	   <img src="themes/dot.gif" title="" alt="" class="icon ic_s_error" /> No activity within 1440 seconds; please log in again
	   </div>
	   <noscript>
...
<input type="hidden" name="db" value="pro" />
<input type="hidden" name="table" value="tab" />
<input type="hidden" name="token" value="ba32af47f7a3c979559e38ad9dca58a5" />
<fieldset>
<legend lang="en" dir="ltr">Language</legend>
<select name="lang" class="autosubmit" lang="en" dir="ltr" id="sel-lang">
<option value="ar">&#1575;&#1604;&#1593;&#1585;&#1576;&#1610;&#1577; - Arabic</option>
<option value="bg"><option value="zh_TW">&#20013;&#25991; - Chinese traditional</option>
</select>
</fieldset>
</form>
</div>
    ...
    <fieldset>
        ...
        <fieldset class="tblFooters">
			...
			<input type="hidden" name="target" value="tbl_create.php" />
			<input type="hidden" name="db" value="pro" />
			<input type="hidden" name="table" value="tab" />
			<input type="hidden" name="token" value="ba32af47f7a3c979559e38ad9dca58a5" />
		</fieldset>
